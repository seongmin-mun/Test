    ...
    <main role="main">
        ...
        <div class="container">
          ...
          <h4 class="jumbotron-heading"><p>Context window size</p></h4>
              ...
              <p><textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" cols = "100" rows="10" name="sentence" placeholder="Input your sentence ..." style="background:#fafbfc"></textarea></p>
              </div>
